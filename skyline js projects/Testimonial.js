...
function switchTest(currentTest){
  ...
  // an Attr object represents an HTML attribute. containing a NamedNodeMap( is an array-like unordered collection of an element's attributes) which is a list of Attr objects.
  if(testId > counter){
